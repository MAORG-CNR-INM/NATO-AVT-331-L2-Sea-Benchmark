...
c=======================================================================
c
       subroutine jellqua(x12,y12,z12,x23,y23,z23,x13,y13,z13,x34,y34,
     $      z34,x41,y41,z41,xp,yp,zp,w123,w341,cosxl,cosyl,coszl,vll)
c
...
c
     ...
     $                      2.0 * cosyl * coszl * vw
c----------------------------------------------------------------------
c SECONDO TRIANGOLO: le quantita' xj3,yj3,zj3; a3; den3_3,den3_5;
c              			  fpx3,fpy3,fpz3,fxy3,fxz3,fyz3; 
...
c
       ...
       fyz2 = 3.0 * yj2 * zj2 * den2_5
c
       u = - w341 * (fpx1+fpx2+fpx3)
       v = - w341 * (fpy1+fpy2+fpy3)
       w = - w341 * (fpz1+fpz2+fpz3)
       uv= - w341 * (fxy1+fxy2+fxy3)
       uw= - w341 * (fxz1+fxz2+fxz3)
       vw= - w341 * (fyz1+fyz2+fyz3)
c
       vll = vll + (cosxl**2*u+2.0*cosxl*cosyl*uv+cosyl**2*v)+
     $       coszl**2*w+2.0*cosxl*coszl*uw+2.0*cosyl*coszl*vw
c
       return
       end
